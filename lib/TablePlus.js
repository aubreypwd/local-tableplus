 ...
 */
class TablePlus extends react_1.default.Component {
    /**
     * Constructor.
     *
     * @author Aubrey Portwood <aubrey@webdevstudios.com>
    ...
    stateButtonStyles() {
        return this.canConnect()
            ? Object.assign(Object.assign({}, this.defaultButtonStyles()), { 'color': '#ffa600' }) : this.defaultButtonStyles();
    }
    /**
     ...
     */
    render() {
        return (react_1.default.createElement(local_components_1.TextButton, { disabled: this.state.disabled, style: this.state.style, onClick: () => this.openTablePlus() }, this.getButtonLabel()));
    }
}
